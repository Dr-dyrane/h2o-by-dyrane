...
- **F6 contact — Fixed (code); confirm number.** Added `WhatsAppFloat` (ported from AU Mosaic: fixed capsule, prefilled chat, hover chip, `data-cta` tag, safe-area) and wired it into `Index.tsx`. Number set to `19517284218` (+1, Hemet CA).
